...
// ---------------- class DCStr --------------------
  class DCStr {
   public:
    ...
    int             GetBufferLen  () const noexcept {  // MEASURE UP T0 DCStrAppendZone - DCStrEndingZone
    ...
    DCStr           Make          (CSTR ThisStr, int ThisLen = -1) const noexcept {
      if(ThisLen                == -1){
    ...
    DCStr           Left          (int Indx) const noexcept {
      if((Indx                 <= 0)
      ){
        return DCStr("");
      }
    ...
    DCStr           Right         (int Indx) const noexcept {
      if((Indx                 <= 0)
       ){
        return DCStr("");
      }
    ...
    DCStr           Mid           (int ThisStart, int ThisLen = -1) const noexcept {
      if(ThisLen                <= -1){
    ...
    int             Find          (CSTR ThisMatch, int ThisStart = 0) const noexcept {
      if((ThisStart           < 0)
      ){
        ThisStart               = 0;
      } else 
    ...
    int             Find          (CHAR ThisMatch, int ThisStart = 0) const noexcept {
      if((ThisStart             < 0)
      ){
        ThisStart               = 0;
      } else 
